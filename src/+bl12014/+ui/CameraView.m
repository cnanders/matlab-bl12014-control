classdef CameraView < mic.Base
    ...
    methods
        ...
        % See also PUPILFILL, INIT, DELETE
            ...
            this.uiPopupType.build(this.hFigure, 10, 10, 100, 24);
            this.buildPanel1x1();
            % this.buildPanel2x2();
    ...
    methods (Access = private)
        ...
        function buildPanel2x2(this)
            ...
            if ishandle(this.hFigure)
                ...
                this.hPanel2x2 =  uipanel(...
                    ...
                    'Position',             mic.Utils.lt2lb([10 50 dWidth dHeight], this.hFigure) ...
                );
                drawnow; 
                ...
                this.hAxes2x2A = axes(...
                    ...
                    'Units',                'pixels',...
                    'Position',             mic.Utils.lt2lb([0 0 dWidth/2 dHeight/2], this.hPanel2x2), ...
                ...
                this.hAxes2x2B = axes(...
                    'Parent',               this.hPanel2x2, ...
                    'Units',                'pixels', ...
                    'Position',             mic.Utils.lt2lb([dWidth/2 0 dWidth/2 dHeight/2], this.hPanel2x2), ...
                    'DataAspectRatio',      [1 1 1], ...
                    'XColor',               [0 0 0], ...
                    'YColor',               [0 0 0], ...
                    'HandleVisibility',     'on', ...
                ...
                this.hAxes2x2C = axes(...
                    'Parent',               this.hPanel2x2, ...
                    'Units',                'pixels', ...
                    'Position',             mic.Utils.lt2lb([0 dHeight/2 dWidth/2 dHeight/2], this.hPanel2x2), ...
                    'DataAspectRatio',      [1 1 1], ...
                    'HandleVisibility',     'on', ...
                    'Color',                [0.2 0 0], ...
                    'Visible',              'on'...
                ...
                this.hAxes2x2D = axes(...
                    'Parent',               this.hPanel2x2, ...
                    'Units',                'pixels', ...
                    'Position',             mic.Utils.lt2lb([dWidth/2 dHeight/2 dWidth/2 dHeight/2], this.hPanel2x2), ...
                    'DataAspectRatio',      [1 1 1], ...
                    'HandleVisibility',     'on', ...
                    'Visible',              'on'...
                );
            ...
            if ishandle(this.hFigure)
                ...
                drawnow;
                    ...
                    this.hAxes1x1 = axes(...
                        ...
                        'Position',             mic.Utils.lt2lb([0 0 dWidth dHeight], this.hPanel1x1), ...
                        'Units',                'pixels', ...
                        'DataAspectRatio',      [1 1 1], ...
                        'HandleVisibility',     'on', ...
                        'Visible',              'on'...
                    ...
                    this.hImage1x1 = image(...
                        zeros(res(2), res(1), bands), ...
                        'Parent', this.hAxes1x1 ...
                    );
                
            end
            
            try
                preview(this.vi, this.hImage1x1); 
            catch mE
                error(getReport(mE));
            end
        ...
        function init(this)
            ...
            this.uiPopupType = mic.ui.common.Popup(...
                'ceOptions', {'Single', '2 x 2'}, ...
                'cLabel', 'Select Display Type', ...
                'fhDirectCallback', @this.onUiPopupType ...
            );
        ...
        function onUiPopupType(this, src, evt)
            
            this.msg('CameraView.onUiPopupType()');
            
            % Build the sub-panel based on popup type 
            switch this.uiPopupType.getSelectedIndex()
                case uint8(1)
                    % 1 x 1
            ...
            if (~isempty(h) && ishandle(h))
                ...
                for n = 1:length(ceh)            
                    ...
                    if  ishandle(ceh{n}) & ...
                        ...
                        ceOptions =  this.uiPopupType.getOptions();
                        this.msg(sprintf('CameraView.hideOtherTypePanels() hiding %s panel' ,ceOptions{uint8(n)}));
