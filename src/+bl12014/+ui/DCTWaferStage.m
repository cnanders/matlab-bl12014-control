    ...
    methods (Access = private)
        ...
        function initUiX(this)
            ...
            this.uiX = mic.ui.device.GetSetNumber(...
                ...
                ...
                'fhGet', @() this.hardware.getDCTWaferStage().getAxisPosition(u8Axis), ...
                'fhSet', @(dVal) this.hardware.getDCTWaferStage().moveAxisAbsolute(u8Axis, dVal), ...
                'fhIsReady', @() this.hardware.getDCTWaferStage().getAxisIsReady(u8Axis), ...
                'fhStop', @() this.hardware.getDCTWaferStage().stopAxisMove(u8Axis), ...
                'fhInitialize', @() mic.Utils.evalAll(...
                    @() this.hardware.getDCTWaferStage().initializeAxis(u8Axis) ...
                ), ... % wrap because fhInitialize doesn't expect a return but initializeAxis returns something
                'fhIsInitialized', @() this.hardware.getDCTWaferStage.getAxisIsInitialized(u8Axis), ...
                ...
                'fhIsVirtual', @() false, ...
