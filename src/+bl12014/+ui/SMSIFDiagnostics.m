classdef SMSIFDiagnostics < mic.Base
    ...
    properties (SetAccess = private)
        ...
        cName = 'sms-if-diagnostics'
    end
    
    methods
        
        function this = SMSIFDiagnostics(varargin)
    ...
    methods (Access = private)
        ...
        %{
         function onFigureCloseRequest(this, src, evt)
            this.msg('SMSIFDiagnosticsControl.closeRequestFcn()');
            delete(this.hParent);
            this.hParent = [];
         end
        %}
        ...
        function init(this)
            ...
            this.uiButtonWheelLeft = mic.ui.common.Button(...
                'cText', '<<', ...
                'fhOnPress', @(src, evt)this.hardware.getNewFocus8742MA().moveIndefinitely(3, -1), ...
                'fhOnRelease', @(src, evt) this.hardware.getNewFocus8742MA().stop(3) ...
            );
