classdef Wafer < mic.Base
	...
	properties
        ...
        uiStateHydra1LimitsOK
        uiStatePpmacCS1TrajectoryLimitsOK
        uiStatePpmacCS1TrajectoryDemandOK
    ...
    methods
        ...
        function build(this, hParent, dLeft, dTop)
            ...
            dTop = 20;
            dLeft = dLeft + this.uiWorkingMode.dWidth + 10;
           ...
           % this.uiStateHydraWaferVelAccOK.build(this.hParent, dLeft, dTop, dWidthSequence);
            ...
            this.uiStateHydra1LimitsOK.build(this.hParent, dLeft, dTop, dWidthSequence);
            dTop = dTop + 30;
            
            this.uiStatePpmacCS1TrajectoryLimitsOK.build(this.hParent, dLeft, dTop, dWidthSequence);
            dTop = dTop + 30;
            
            this.uiStatePpmacCS1TrajectoryDemandOK.build(this.hParent, dLeft, dTop, dWidthSequence);
            dTop = dTop + 30;
...
%}
            ...
            this.uiWaferTTZClosedLoop = bl12014.ui.WaferTTZClosedLoop( ...
                ...
                'dZTol',  1.5, ...0.5, ... % changing to 2 2020.01.13
                'dDelayZ', 0.5, ... % trying this to see if it works better
            ...
            this.uiStateHydraWaferVelAccOK = mic.ui.TaskSequence(...
                'cName', [this.cName, 'ui-state-hydra-wafer-vel-acc-ok'], ...
                'task', bl12014.Tasks.createStateHydraWaferVelAccOK(...
                    [this.cName, 'state-hydra-wafer-vel-acc-ok'], ...
                    this.hardware, ...
                    this.clock ...
                ), ...
                'lShowIsDone', true, ...
            ...
            cSubName = 'state-hydra-1-limtis-ok';
            this.uiStateHydra1LimitsOK = mic.ui.TaskSequence(...
                'cName', [this.cName, 'ui', cSubName], ...
                'task', bl12014.Tasks.createStateHydra1LimitsOK(...
                    [this.cName, cSubName], ...
                    this.hardware, ...
                    this.clock ...
                ), ...
            ...
            cSubName = 'state-ppmac-cs1-trajectory-limits-ok';
            this.uiStatePpmacCS1TrajectoryLimitsOK = mic.ui.TaskSequence(...
                'cName', [this.cName, 'ui', cSubName], ...
                'task', bl12014.Tasks.createStatePpmacCS1TrajectoryLimitsOK(...
                    [this.cName, cSubName], ...
                    this.hardware, ...
                    this.clock ...
                ), ...
            ...
            cSubName = 'state-ppmac-cs1-trajectory-demand-ok';
            this.uiStatePpmacCS1TrajectoryDemandOK = mic.ui.TaskSequence(...
                'cName', [this.cName, 'ui', cSubName], ...
                'task', bl12014.Tasks.createStatePpmacCS1TrajectoryDemandOK(...
                    [this.cName, cSubName], ...
                    this.hardware, ...
                    this.clock ...
                ), ...
