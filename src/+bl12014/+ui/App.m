classdef App < mic.Base
    ...
    methods (Access = private)
        ...
        function init(this)
            ...
            this.uiClockMACentering = mic.ui.Clock(this.clock);
            ...
            this.uiMACentering = bl12014.ui.MACentering( ...
                'hardware', this.hardware, ...
                'clock', this.clock, ...
            ...
            this.uiUniformity = bl12014.ui.Uniformity(...
                'hardware', this.hardware, ...
                'clock', this.clock, ...
                'uiReticleFiducializedMove', this.uiReticle.uiReticleFiducializedMove, ...
            ...
            this.uiCurrentOfRing = mic.ui.device.GetNumber(...
                ...
                'fhGet', @() bl12014.hardwareAssets.middleware.getRingCurrent(), ...
                'fhIsVirtual', @() false, ...
            ...
            this.uiPowerPmacHydraMotMinMonitor = bl12014.ui.PowerPmacHydraMotMinGradLowNormHighMonitor(...
                'hardware', this.hardware, ...
                'clock', this.clock, ...
                'uiClock', this.uiClockDMIPowerMonitor ...
            );
        ...
        function onUiTabGroup(this)
            ...
            switch cTab
                ...
                case 'PPMAC Hydra Mot Min'
                    ...
                    this.uiPowerPmacAccel.build(hTab, 10, 300);
                case 'FEM Control'
