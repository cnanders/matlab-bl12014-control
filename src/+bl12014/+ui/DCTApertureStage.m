classdef DCTApertureStage < mic.Base
    ...
    methods
        ...
        function this = DCTApertureStage(varargin)
    ...
    methods (Access = private)
        ...
        function initUiX(this)
            ...
            cPathConfig = fullfile(...
                ...
                'get-set-number', ...
                'config-dct-aperture-stage-x.json' ...
            );
            ...
            this.uiX = mic.ui.device.GetSetNumber(...
                ...
                ...
                'fhGet', @() this.hardware.getDCTApertureStage().getPosition(u8Axis), ...
                'fhSet', @(dVal) this.hardware.getDCTApertureStage().goToPositionAbsolute(u8Axis, dVal), ...
                'fhIsReady', @() ~this.hardware.getDCTApertureStage().getIsMoving(u8Axis), ...
                'fhStop', @() this.hardware.getDCTApertureStage().stop(u8Axis), ...
                'fhInitialize', @()this.hardware.getDCTApertureStage().findReferenceMark(u8Axis), ...
                'fhIsInitialized', @() this.hardware.getDCTApertureStage.getIsReferenced(u8Axis), ...
                ...
                'fhIsVirtual', @() false, ...
        ...
        function initUiY(this)
            ...
            cPathConfig = fullfile(...
                bl12014.Utils.pathUiConfig(), ...
                'get-set-number', ...
                'config-dct-aperture-stage-y.json' ...
            );
