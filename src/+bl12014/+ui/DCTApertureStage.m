    ...
    methods (Access = private)
        ...
        function initUiX(this)
            ...
            this.uiX = mic.ui.device.GetSetNumber(...
                ...
                ...
                'fhGet', @() this.hardware.getDCTApertureStage().getAxisPosition(u8Axis), ...
                'fhSet', @(dVal) this.hardware.getDCTApertureStage().moveAxisAbsolute(u8Axis, dVal), ...
                'fhIsReady', @() this.hardware.getDCTApertureStage().getAxisIsReady(u8Axis), ...
                'fhStop', @() this.hardware.getDCTApertureStage().stopAxisMove(u8Axis), ...
                'fhInitialize', @() mic.Utils.evalAll(...
                    @() this.hardware.getDCTApertureStage().initializeAxis(u8Axis) ...
                ), ... % wrap because fhInitialize doesn't expect a return but initializeAxis returns something
                'fhIsInitialized', @() this.hardware.getDCTApertureStage.getAxisIsInitialized(u8Axis), ...
                ...
                'fhIsVirtual', @() false, ...
