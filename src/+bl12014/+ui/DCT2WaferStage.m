classdef DCT2WaferStage < mic.Base
    ...
    methods
        ...
        function this = DCT2WaferStage(varargin)
    ...
    methods (Access = private)
        ...
        function initUiX(this)
            ...
            this.uiX = mic.ui.device.GetSetNumber(...
                ...
                ...
                'fhGet', @() this.hardware.getDCT2WaferStage().getAxisPosition(u8Axis), ...
                'fhSet', @(dVal) this.hardware.getDCT2WaferStage().moveAxisAbsolute(u8Axis, dVal), ...
                'fhIsReady', @() this.hardware.getDCT2WaferStage().getAxisIsReady(u8Axis), ...
                'fhStop', @() this.hardware.getDCT2WaferStage().stopAxisMove(u8Axis), ...
                'fhInitialize', @() mic.Utils.evalAll(...
                    @() this.hardware.getDCT2WaferStage().initializeAxis(u8Axis) ...
                ), ... % wrap because fhInitialize doesn't expect a return but initializeAxis returns something
                'fhIsInitialized', @() this.hardware.getDCT2WaferStage.getAxisIsInitialized(u8Axis), ...
                ...
                'fhIsVirtual', @() false, ...
