classdef M141 < mic.Base
    ...
    methods
        ...
        function build(this, hParent, dLeft, dTop)
            ...
            this.uiSwitch.build(this.hPanel, dLeft, dTop);
            dTop = dTop + dSep;
    ...
    methods (Access = private)
        ...
        function initUiSwitch(this)
            ...
            this.uiSwitch = mic.ui.device.GetSetLogical(...
                'clock', this.clock, ...
                'config', uiConfig, ...
                'dWidthName', 300, ...
                'ceVararginCommandToggle', this.getCommandToggleParams(), ...
                'cName', [this.cName, '-branch-outlet-1'], ...
                'lShowInitButton', false, ...
                'lShowLabels', false, ...
                ...
                'fhIsVirtual', @() false, ...
                'lUseFunctionCallbacks', true, ...
                'cLabel', 'M141 SmarAct MCS Power (via ControlByWeb)' ...
            );
        end
