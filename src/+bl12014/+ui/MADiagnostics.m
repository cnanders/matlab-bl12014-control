classdef MADiagnostics < mic.Base
    ...
    methods
        ...
        function build(this, hParent, dLeft, dTop)
            ...
            dTop = dTop + dSep;
            this.uiModbusIris.build(this.hPanel, dLeft, dTop);
            dTop = dTop + dSep;
    ...
    methods (Access = private)
        ...
        function init(this)
            ...
            this.uiModbusIris = mic.ui.device.GetSetNumber(...
                'clock', this.clock, ...
                'dWidthVal', this.dWidthVal, ...
                'dWidthName', this.dWidthName, ...
                'dWidthPadName', this.dWidthPadName, ...
                ...
                'lShowStep', false, ...
                'lShowStepPos', false, ...
                'cName', sprintf('%s-iris', this.cName), ...
                'config', uiConfig, ...
                'fhGet', @() this.hardware.getModbusIris().getCounts(), ...
                'fhSet', @(dVal) this.hardware.getModbusIris().setCounts(dVal), ...
                'fhStop', @() this.hardware.getModbusIris().abortMove(u8Axis), ...
                'fhIsVirtual', @() false, ...
                'lUseFunctionCallbacks', true, ...
                'cLabel', 'Iris' ...
            );
