classdef HeightSensorZClosedLoop < mic.Base
    ...
    methods
        ...
        function connectDeltaTauPowerPmacAndDriftMonitor(this, commDeltaTauPowerPmac, commDriftMonitor)
            ...
            this.uiZWaferCoarse.setDevice(deviceZWaferCoarse);
            this.uiZWaferCoarse.turnOn();
            this.uiZWaferCoarse.syncDestination();
        ...
        function build(this, hParent, dLeft, dTop)
            ...
            this.hPanel = uipanel(...
                'Parent', hParent,...
                'Units', 'pixels',...
                'Title', 'Height Sensor Z Fine (Adjust WFZ and WCZ to Achieve Target) (Tol = 1 nm) (PPMAC + DriftMon)',...
                'Clipping', 'on',...
    ...
    methods (Access = private)
        ...
        function initUiZWaferCoarse(this)
            ...
            this.uiZWaferCoarse = mic.ui.device.GetSetNumber(...
                'clock', this.clock, ...
                'lShowLabels', false, ...
                'dWidthName', this.dWidthName, ...
                'dWidthDest', 70, ...
