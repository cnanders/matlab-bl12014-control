...
%             dTop = dTop + dSep;
    ...
    methods (Access = private)
        ...
        function initUiCommWebSwitch1(this)
            ...
            this.uiCommWebSwitch1 = mic.ui.device.GetSetLogical(...
                ...
                'fhSet', @(lVal) this.hardware.setIsConnectedWebSwitchBeamline(lVal), ...
                'fhIsVirtual', @() false, ...
                'lUseFunctionCallbacks', true, ...
        ...
        function initUiCommWebSwitch2(this)
            ...
            this.uiCommWebSwitch2 = mic.ui.device.GetSetLogical(...
                ...
                'fhSet', @(lVal) this.hardware.setIsConnectedWebSwitchEndstation(lVal), ...
                'fhIsVirtual', @() false, ...
                'lUseFunctionCallbacks', true, ...
        ...
        function init(this)
            ...
            this.initUiCommWebSwitch1();
            % this.initUiCommWebSwitch2();
