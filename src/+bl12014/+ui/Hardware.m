...
%             dTop = dTop + dSep;
            ...
            this.uiGalilM1.build(hParent, dLeft, dTop);
            dTop = dTop + dSep;
...
%             dTop = dTop + dSep;
            ...
            this.uiModbusIris.build(hParent, dLeft, dTop);
    ...
    methods (Access = private)
        ...
        function initUiALS(this)
         ...
         function initUiSMS(this)
            ...
            this.uiSMS = mic.ui.device.GetSetLogical(...
                'clock', this.uiClock, ...
                'ceVararginCommandToggle', ceVararginCommandToggle, ...
                'dWidthName', this.dWidthName, ...
                'lShowLabels', false, ...
                'lShowDevice', false, ...
                'lShowInitButton', false, ...
                'fhGet', @() this.hardware.getIsConnectedSMS(), ...
                'fhSet', @(lVal) mic.Utils.ternEval(...
                    lVal, ...
                    @() mic.Utils.evalAll(...
                        @() this.hardware.connectSMS() ...
                    ), ...
                    @() mic.Utils.evalAll(...
                        @() this.hardware.disconnectSMS() ...
                    )...
                ), ...
                'fhIsVirtual', @() false, ...
                'lUseFunctionCallbacks', true, ...
                'cName', [this.cName, 'commSMS'], ...
                'cLabel', 'SMS (Source)' ...
            );
        ...
        function initUiMfDriftMonitor(this)
         ...
         function initUiDataTranslationMeasurPoint(this)
            ...
            this.uiDataTranslationMeasurPoint = mic.ui.device.GetSetLogical(...
                ...
                'fhSet', @(lVal) mic.Utils.ternEval(...
                    ...
                    @() this.hardware.disconnectDataTranslation() ...
                ), ...
                'fhIsVirtual', @() false, ...
                'lUseFunctionCallbacks', true, ...
         ...
         function initUiTekAFG31021(this)
            ...
            this.uiTekAFG31021 = mic.ui.device.GetSetLogical(...
                'clock', this.uiClock, ...
                'ceVararginCommandToggle', ceVararginCommandToggle, ...
                'dWidthName', this.dWidthName, ...
                'lShowLabels', false, ...
                'lShowDevice', false, ...
                'lShowInitButton', false, ...
                'cName', [this.cName, 'comm-tek-afg31021'], ...
                'fhGet', @() this.hardware.getIsConnectedTekAFG31021(), ...
                'fhSet', @(lVal) mic.Utils.ternEval(...
                    lVal, ...
                    @() this.hardware.connectTekAFG31021(), ...
                    @() this.hardware.disconnectTekAFG31021() ...
                ), ...
                'fhIsVirtual', @() false, ...
                'lUseFunctionCallbacks', true, ...
                'cLabel', 'Tek AFG31021 (Shutter 2021 Q4)' ...
            );
         ...
         function initUiGalilM1(this)
           ...
           this.uiGalilM1  = mic.ui.device.GetSetLogical(...
               'clock', this.uiClock, ...
               'ceVararginCommandToggle', ceVararginCommandToggle, ...
               'dWidthName', this.dWidthName, ...
               'lShowLabels', false, ...
               'lShowDevice', false, ...
               'lShowInitButton', false, ...
               'cName', [this.cName, 'comm-galil-m1'], ...
               'fhGet', @() this.hardware.getIsConnectedGalilM1(), ...
               'fhSet', @(lVal) mic.Utils.ternEval(...
                   lVal, ...
                   @() this.hardware.connectGalilM1(), ...
                   @() this.hardware.disconnectGalilM1() ...
               ), ...
               'fhIsVirtual', @() false, ...
               'lUseFunctionCallbacks', true, ...
               'cLabel', 'Galil M1 (M1 wobbler)' ...
           );
         ...
         function initUiIris(this)
            ...
            this.uiModbusIris = mic.ui.device.GetSetLogical(...
                'clock', this.uiClock, ...
                'ceVararginCommandToggle', ceVararginCommandToggle, ...
                    'dWidthName', this.dWidthName, ...
                'lShowLabels', false, ...
                'lShowDevice', false, ...
                'lShowInitButton', false, ...
                'fhGet', @() this.hardware.getIsConnectedIris(), ...
                'fhSet', @(lVal) mic.Utils.ternEval(...
                    lVal, ...
                        @() this.hardware.connectIrisModbus(), ...
                        @() this.hardware.disconnectIrisModbus() ...                  
                ), ...
                'fhIsVirtual', @() false, ...
                'lUseFunctionCallbacks', true, ...
                    'cName', [this.cName, 'iris-modbus'], ...
                    'cLabel', 'Iris' ...
                );
         end
