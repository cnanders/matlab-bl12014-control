classdef ExitSlit < mic.Base
    ...
    methods
        ...
        function build(this, hParent, dLeft, dTop)
            ...
            this.uiStep.build(this.hPanel, dLeft + 350, dTop);
    ...
    methods (Access = private)
        ...
        function initUiStep(this)
            
            cPathConfig = fullfile(...
                bl12014.Utils.pathUiConfig(), ...
                'get-set-number', ...
                'config-step-of-exit-slit.json' ...
            );
            ...
            device = bl12014.device.GetSetNumberFromExitSlitObject(...
                @() this.hardware.getExitSlit(), ...
                bl12014.device.GetSetNumberFromExitSlitObject.cPROP_STEP);
            
            
            ceProps = this.getUiStageCommonProps();
            this.uiStep = mic.ui.device.GetSetNumber(...
                'clock', this.clock, ...
                ceProps{:}, ...
                'fhGet', @() device.get(), ...
                'fhSet', @(dVal) device.set(dVal), ...
                ...
                'lShowRange', true, ...
                'dWidthStores', 150, ...
                'cName', [this.cName, '-step'], ...
                'config', uiConfig, ...
                'cLabel', 'CL Step Max (um)' ...
            );
        end
