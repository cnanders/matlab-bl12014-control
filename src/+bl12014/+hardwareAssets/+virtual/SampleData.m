...
classdef SampleData < handle
    ...
    methods
        ...
        function this = SampleData(varargin)
            this.u32DmiData = randi(200, 1, 4) - 100;
            this.u32HsData = randi(50e3, 1, 24) + 425e3;
        end
        
        % Returns {uint32 1 x 4} of most recent HS / DMI 1 kHz data
        % @param {int32 1x1} i32Samples - number of samples, max 10k.
        % @return {uint32 1x4} - four raw DMI values of a 1 ms instant of time
        ...
        % @return {uint32 x 24} - of one ms worth of acquisition time.
