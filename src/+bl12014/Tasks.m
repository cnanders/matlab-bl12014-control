    ...
    methods (Static)
        ...
        function task = createStateUndulatorIsCalibrated(cName, ui, clock)
            ...
            fhGetMessage = @() [...
                ...
                sprintf('(%1.2f mm)', ui.getGapOfUndulatorCalibrated()) ...
            ];
        ...
        function task = createSequenceTurnOnReticleHydra(cName, uiMotMin, uiWorkingMode, clock)
            ...
            ceTasks = {...
                mic.Task.fromUiGetSetNumber(uiWorkingMode, 0, 0.1, 'mode', 'Working Mode'), ...
                mic.Task.fromUiGetSetNumber(uiMotMin.ui3, 4, 0.1, 'A', 'RCX MotMin'), ...
                mic.Task.fromUiGetSetNumber(uiMotMin.ui4, 3.5, 0.1, 'A', 'RCY MotMin'), ...
                mic.Task.fromUiGetSetNumber(uiWorkingMode, 1, 0.1, 'mode', 'Working Mode') ...
            };
        ...
        function task = createStateWaferHydraOn(cName, uiMotMin, clock)
            ...
            ceTasks = {...
                mic.Task.fromUiGetSetNumber(uiMotMin.ui1, 4, 1, 'A'), ...
                mic.Task.fromUiGetSetNumber(uiMotMin.ui2, 4, 1, 'A'), ...
            };
        ...
        function task = createStateReticleHydraOn(cName, uiMotMin, clock)
            ...
            ceTasks = {...
                mic.Task.fromUiGetSetNumber(uiMotMin.ui3, 4, 1, 'A'), ...
                mic.Task.fromUiGetSetNumber(uiMotMin.ui4, 3.5, 1, 'A'), ...
            };
        ...
        function task = createSequenceLevelWafer(...
            ...
            fhGetMessage = sprintf('Level Wafer (x %1.0fum, y %1.0fum, z %1.0fnm)', ...
                stConfigDat.tiltX.value, ...
                stConfigDat.tiltY.value, ...
                stConfigDat.Z.value ...
            );
