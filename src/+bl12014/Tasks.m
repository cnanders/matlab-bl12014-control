    ...
    methods (Static)
        ...
        function task = createStateHydraWaferVelAccOK(cName, hardware, clock)
            ...
            taskAccelMax = mic.Task(...
               ...
               'fhGetMessage', @() sprintf('Set PPMAC Motor[1].InvAmax to %1.0f (%1.0f um/s/s)', 1/dVal, dVal * 1e6) ...
            );
            ...
            taskDecelMax = mic.Task(...
               ...
               'fhGetMessage', @() sprintf('Set PPMAC Motor[1].InvDmax to %1.0f (%1.0f um/s/s)', 1/dVal, dVal * 1e6) ...
            );
            ...
            fhGetMessage = @() [...
                'WCX ', ...
                sprintf('Hydra Vel: %1.0f, ', hardware.getHydraWafer().getVelocity(1)), ...
                sprintf('Acc: %1.0f, ', hardware.getHydraWafer().getAcceleration(1)), ...
                sprintf('PPMAC MaxSpeed: %1.0f mm/s, ', hardware.getDeltaTauPowerPmac().getSpeedMaxOfMotor(1) * 1e3), ...
                sprintf('InvAmax: %1.0f, ', 1/hardware.getDeltaTauPowerPmac().getAccelMaxOfMotor(1)), ...
                sprintf('InvDmax: %1.0f, ', 1/hardware.getDeltaTauPowerPmac().getDecelMaxOfMotor(1)) ...
            ];
