classdef Tasks < mic.Base
    ...
    methods (Static)
        ...
        function task = createStatePowerPmacAccelSetForFEM(cName, hardware, clock)
            ...
            dVal = 500;
            taskTSW = mic.Task(...
               'fhExecute', @() hardware.getDeltaTauPowerPmac().setAccelBlendedOfWaferCoarse(dVal), ...
               'fhIsDone', @() abs(hardware.getDeltaTauPowerPmac().getAccelBlendedOfWaferCoarse() - dVal) < dTol, ...
               'fhGetMessage', @() sprintf('Setting Accel Blended Wafer Hydra %1.0f', dVal) ...
            );
        
            taskTSR = mic.Task(...
               'fhExecute', @() hardware.getDeltaTauPowerPmac().setAccelBlendedOfReticleCoarse(dVal), ...
               'fhIsDone', @() abs(hardware.getDeltaTauPowerPmac().getAccelBlendedOfReticleCoarse() - dVal) < dTol, ...
            ...
            fhGetMessage = @() [...
                'Accel set for FEM: ', ...
                sprintf('Time Accel W %1.0f, ', hardware.getDeltaTauPowerPmac().getAccelOfWaferCoarse()), ...
                sprintf('Time Accel R %1.0f, ', hardware.getDeltaTauPowerPmac().getAccelOfReticleCoarse()), ...
                sprintf('Time Accel S W %1.0f, ', hardware.getDeltaTauPowerPmac().getAccelBlendedOfWaferCoarse()), ...
                sprintf('Time Accel S R %1.0f ', hardware.getDeltaTauPowerPmac().getAccelBlendedOfReticleCoarse()) ...
            ];
        ...
        function task = createStateHydraWaferVelAccOK(cName, hardware, clock)
            ...
            dVal = 95e-6; % mm/ms/ms  is the unit the PPMAC takes the e-6 is the 1/1000 *1/1000 to get 1/ms/ms units rather than 1/s/s units
            dTol = 0.1 * dVal; % 10%
            ...
            fhGetMessage = @() [...
                'WCX ', ...
                sprintf('Hydra Vel: %1.0f mm/s, ', hardware.getHydraWafer().getVelocity(1)), ...
                sprintf('Acc: %1.0f mm/s/s, ', hardware.getHydraWafer().getAcceleration(1)), ...
                ... sprintf('Dec: %1.0f mm/s/s, ', hardware.getHydraWafer().getDeceleration(1)), ...
                ...
                'WCY', ...
                sprintf('Hydra Vel: %1.0f mm/s, ', hardware.getHydraWafer().getVelocity(2)), ...
                sprintf('Acc: %1.0f mm/s/s, ', hardware.getHydraWafer().getAcceleration(2)), ...
                ... sprintf('Dec: %1.0f mm/s/s, ', hardware.getHydraWafer().getDeceleration(1)), ...
                ...
                %}
                sprintf('DemandTSCS1: %1.0f ms, ', hardware.getDeltaTauPowerPmac().getAccelBlendedOfWaferCoarse())
            ];
        ...
        function task = createStatePowerPmacAccelSetToDefault(cName, hardware, clock)
            ...
            fhGetMessage = @() [...
                ...
                sprintf('TS W %1.0f, ', hardware.getDeltaTauPowerPmac().getAccelBlendedOfWaferCoarse()), ...
                sprintf('TS R %1.0f ', hardware.getDeltaTauPowerPmac().getAccelBlendedOfReticleCoarse()) ...
            ];
