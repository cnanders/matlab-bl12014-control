classdef Tasks < mic.Base
    ...
    methods (Static)
        ...
        function task = createStatePpmacCS1TrajectoryLimitsOK(cName, hardware, clock)
            ...
            dVal = 50e-6; % mm/ms/ms  is the unit the PPMAC takes the e-6 is the 1/1000 *1/1000 to get 1/ms/ms units rather than 1/s/s units
            dTol = 0.1 * dVal; % 10%
        ...
        function task = createStateHardwareConnected(cName, ui, clock)
            ...
            ceTasks = {...
               ...
               mic.Task.fromUiGetSetLogical(ui.uiDoseMonitor, true), ...
                ... 2022.01 COMMENT WHILE ALS DOWN mic.Task.fromUiGetSetLogical(ui.uiALS, true), ...
